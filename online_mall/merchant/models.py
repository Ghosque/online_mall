...
class CommodityColor(models.Model):
    commodity_class = ListTextField(base_field=models.CharField(), size=60, verbose_name='分类')
...
class Specification(models.Model):
    information = ListTextField(base_field=models.CharField(), size=100, verbose_name='详情')
